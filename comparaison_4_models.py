...
####################     moyenne pour gpt    ####################
with open("responses_gpt_analyzed.csv", encoding="utf-8") as f:
    somme_longueur = 0
    somme_negative = 0
    somme_neutre = 0
    somme_positive = 0
    ...
    reponses.append(["gpt-oss-120b", somme_longueur/cpt, somme_negative/cpt, somme_neutre/cpt, somme_positive/cpt, somme_polairte/cpt])


with open("comparaison_4_models.csv", "w", newline="", encoding="utf-8") as f:
    writer = csv.writer(f)
